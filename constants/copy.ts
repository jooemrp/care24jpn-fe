 ...
 * `shortLabel` is the SP shortcut-bar text; omit it to keep the item hamburger-only. */
export const nav: { href: string; label: Bilingual; shortLabel?: Bilingual }[] = [
  { href: "/", label: { ja: "ホーム", en: "Home" } },
  {
    href: "/#service-details",
    label: { ja: "サービス内容", en: "Service Details" },
    shortLabel: { ja: "サービス", en: "Service" },
  },
  {
    href: "/service-flow",
  ...
  {
    href: "/pricing",
    label: { ja: "ご利用料金", en: "Usage Fees" },
    shortLabel: { ja: "料金", en: "Fees" },
  },
  { href: "/faq", label: { ja: "よくあるご質問", en: "FAQ" } },
  { href: "/contact", label: { ja: "お問い合わせ", en: "Contact Us" } },
];
  ...
  about: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: {
          ja: "保険では対応できないご要望にも\n柔軟に対応します。",
          en: "Since it is non-insurance, we can flexibly adapt\nto special requests outside standard insurance constraints.",
        } satisfies Bilingual,
      },
    ],
  },
  ...
  flow: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: {
          ja: "サービス終了後、内容をもとに\nレポートを作成・ご報告します。",
          en: "After the visit, we prepare and share\na report based on the session.",
        } satisfies Bilingual,
      },
    ],
  },
  ...
  pricingSummary: {
    ...
    payment: {
      ...
      icon: {
        ...
        alt: { ja: "銀行振込", en: "Bank transfer" } satisfies Bilingual,
      },
    },
  },
};
...
export const serviceFlow = {
  hero: {
    ...
    // Relative path, resolved through `localizeHref()` at render time.
    ctaHref: "/contact",
  },
...
export const pricing = {
  ...
  paymentIconAlt: { ja: "銀行振込", en: "Bank transfer" } satisfies Bilingual,
};
