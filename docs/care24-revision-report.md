...
| 4 | 6 | Sticky Phone + Contact CTA after FV | Current branch has a full-width blue/pink desktop rail with a centered `max-w-6xl` CTA grid aligned to the navbar, pink `お問合せ` side, stronger button affordance, and mobile split CTA. | [Max-width desktop screenshot](../qa-after-cta-maxwidth.png), [production desktop screenshot](../qa-final-desktop.png), [mobile screenshot](../qa-final-menu-mobile.png) |
