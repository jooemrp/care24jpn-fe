...
const BLOCK_TYPES: BlockTypeSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "care_amount", label: "Care course amount", field_type: "text", localizable: true, required: false, sort_order: 2 },
      { name: "care_min_note", label: "Care course minimum note", field_type: "text", localizable: true, required: false, sort_order: 3 },
      { name: "care_transport_note", label: "Care course transport note", field_type: "text", localizable: true, required: false, sort_order: 4 },
      { name: "nursing_label", label: "Nursing course label", field_type: "text", localizable: true, required: false, sort_order: 5 },
      { name: "nursing_amount", label: "Nursing course amount", field_type: "text", localizable: true, required: false, sort_order: 6 },
      { name: "nursing_min_note", label: "Nursing course minimum note", field_type: "text", localizable: true, required: false, sort_order: 7 },
      { name: "nursing_transport_note", label: "Nursing course transport note", field_type: "text", localizable: true, required: false, sort_order: 8 },
      { name: "extension_note", label: "Extension note", field_type: "text", localizable: true, required: false, sort_order: 9 },
      { name: "pricing_details_label", label: "Pricing details link label", field_type: "text", localizable: true, required: false, sort_order: 10 },
      { name: "pricing_details_label_mobile", label: "Pricing details link label (mobile)", field_type: "text", localizable: true, required: false, sort_order: 11 },
      { name: "pricing_details_href", label: "Pricing details link href", field_type: "text", localizable: false, required: false, sort_order: 12 },
      { name: "payment_heading", label: "Payment heading", field_type: "text", localizable: true, required: false, sort_order: 13 },
      { name: "payment_body", label: "Payment body", field_type: "textarea", localizable: true, required: false, sort_order: 14 },
      { name: "payment_body_mobile", label: "Payment body (mobile)", field_type: "textarea", localizable: true, required: false, sort_order: 15 },
      { name: "payment_settle_note", label: "Payment settle note", field_type: "text", localizable: true, required: false, sort_order: 16 },
      { name: "payment_visa", label: "Logo Visa", field_type: "image", localizable: false, required: false, sort_order: 17 },
      { name: "payment_visa_alt", label: "Logo Visa alt", field_type: "text", localizable: true, required: false, sort_order: 18 },
      { name: "payment_mastercard", label: "Logo Mastercard", field_type: "image", localizable: false, required: false, sort_order: 19 },
      { name: "payment_mastercard_alt", label: "Logo Mastercard alt", field_type: "text", localizable: true, required: false, sort_order: 20 },
      { name: "payment_jcb", label: "Logo JCB", field_type: "image", localizable: false, required: false, sort_order: 21 },
      { name: "payment_jcb_alt", label: "Logo JCB alt", field_type: "text", localizable: true, required: false, sort_order: 22 },
      { name: "payment_amex", label: "Logo American Express", field_type: "image", localizable: false, required: false, sort_order: 23 },
      { name: "payment_amex_alt", label: "Logo American Express alt", field_type: "text", localizable: true, required: false, sort_order: 24 },
      { name: "payment_icon", label: "Bank transfer icon", field_type: "image", localizable: false, required: false, sort_order: 25 },
      { name: "payment_icon_alt", label: "Bank transfer icon alt", field_type: "text", localizable: true, required: false, sort_order: 26 },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "medical_note_mobile", label: "Medical directive footnote (mobile)", field_type: "textarea", localizable: true, required: false, sort_order: 13 },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "consult_body_mobile", label: "Consult body (mobile)", field_type: "textarea", localizable: true, required: false, sort_order: 8 },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "mics_href", label: "mics website href", field_type: "text", localizable: false, required: false, sort_order: 8 },
      { name: "contact_cta_href", label: "Contact CTA href", field_type: "text", localizable: false, required: false, sort_order: 9 },
      { name: "lead_in_ornament_start", label: "Lead-in ornament (start)", field_type: "text", localizable: true, required: false, sort_order: 10 },
      { name: "lead_in_ornament_end", label: "Lead-in ornament (end)", field_type: "text", localizable: true, required: false, sort_order: 11 },
    ],
  },
  {
    slug: "rate_course",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "cancellation_href", label: "Cancellation policy link href", field_type: "text", localizable: false, required: false, sort_order: 3 },
      { name: "payment_note", label: "Payment method note", field_type: "textarea", localizable: true, required: false, sort_order: 4 },
      { name: "payment_icon", label: "Bank transfer icon", field_type: "image", localizable: false, required: false, sort_order: 5 },
      { name: "payment_icon_alt", label: "Bank transfer icon alt", field_type: "text", localizable: true, required: false, sort_order: 6 },
    ],
  },
  {
    slug: "fees_meta",
